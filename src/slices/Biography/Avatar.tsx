...
export default function Avatar({
  ...
  return (
    <div ref={component} className={clsx("relative h-full w-full", className)}>
      <div
        className="avatar aspect-square overflow-hidden rounded-3xl border-2 border-slate-900 opacity-0"
...
//     return (
//         <div ref={component} className={clsx("relative h-full w-full", className)}>
//             <div className="avatar aspect-square overflow-hidden rounded-3xl border-2 border-slate-900 opacity-0">
