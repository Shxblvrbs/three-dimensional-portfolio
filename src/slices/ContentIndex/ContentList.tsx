...
//         <div className="hover-reveal pointer-events-none absolute left-0 top-0 -z-10 h-[320px] w-[220px] rounded-lg bg-over bg-center 
//         opacity-0 transition-[background] duration-300"
//             style={{
//                 //If you're using tailwindCSS you can't pass dynamic strings to it that it hasn't seen before
...
export default function ContentList({
  ...
  useEffect(() => {
    ...
    let ctx = gsap.context(() => {
      ...
      return () => ctx.revert(); // cleanup! (the next three lines)
    }, component);
  }, []);
