...
/**
 * Primary content in *ScrollList → Primary*
 */
export interface ScrollListSliceDefaultPrimary {
  /**
   * Heading field in *ScrollList → Primary*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: scroll_list.primary.heading
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  heading: prismic.KeyTextField;
}
...
/**
 * Primary content in *ScrollList → Items*
 */
export interface ScrollListSliceDefaultItem {
  /**
   * Scroll Name field in *ScrollList → Items*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: scroll_list.items[].scroll_name
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  scroll_name: prismic.KeyTextField;

  /**
   * Scroll Color field in *ScrollList → Items*
   *
   * - **Field Type**: Color
   * - **Placeholder**: *None*
   * - **API ID Path**: scroll_list.items[].scroll_color
   * - **Documentation**: https://prismic.io/docs/field#color
   */
  scroll_color: prismic.ColorField;
}

/**
 * Default variation for ScrollList Slice
 *
 * - **API ID**: `default`
 * - **Description**: Default
 * - **Documentation**: https://prismic.io/docs/slice
 */
export type ScrollListSliceDefault = prismic.SharedSliceVariation<
  "default",
  Simplify<ScrollListSliceDefaultPrimary>,
  Simplify<ScrollListSliceDefaultItem>
>;

/**
 * Slice variation for *ScrollList*
 */
type ScrollListSliceVariation = ScrollListSliceDefault;

/**
 * ScrollList Shared Slice
 *
 * - **API ID**: `scroll_list`
 * - **Description**: ScrollList
 * - **Documentation**: https://prismic.io/docs/slice
 */
export type ScrollListSlice = prismic.SharedSlice<
  "scroll_list",
  ScrollListSliceVariation
>;
...
declare module "@prismicio/client" {
  ...
  namespace Content {
    export type {
      ...
      ScrollListSlice,
      ScrollListSliceDefaultPrimary,
      ScrollListSliceDefaultItem,
      ScrollListSliceVariation,
      ScrollListSliceDefault,
      TextBlockSlice,
